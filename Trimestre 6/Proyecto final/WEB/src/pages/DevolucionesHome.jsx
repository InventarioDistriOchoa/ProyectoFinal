// src/pages/DevolucionesHome.jsx
      ...
      <main className="dashboard py-4 flex-grow-1">
        <div className="fila-opciones justify-content-center">
          <div
            ...
            onClick={() => navigate("/registro-devolucion")}
          >
            <img
              src="/img/devoluciones-de-compras.png"
              alt="Registrar Devolución"
          ...
          <div
            className="opcion tarjeta-dashboard"
            onClick={() => navigate("/registro-tipo-devolucion")}
          >
            <img
              src="/img/devoluciones.png"
              alt="Registrar Tipo Devolución"
              style={{ width: "80px", height: "80px" }}
            />
            <p>Registrar Tipo Devolución</p>
          </div>
        </div>
      </main>
