...
class DevolucionesHomeScreen extends StatefulWidget {
  const DevolucionesHomeScreen({super.key});

  @override
  State<DevolucionesHomeScreen> createState() => _DevolucionesHomeScreenState();
}

class _DevolucionesHomeScreenState extends State<DevolucionesHomeScreen> {
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white.withOpacity(0.18), // 🔥 menos opacidad
                    borderRadius: BorderRadius.circular(22),
                ...
                Expanded(
                  child: Center(
                    child: Wrap(
                      ...
                      children: [
                        _cardOpcion(
                          img: 'assets/img/devoluciones-de-compras.png',
                          text: 'Registrar Devolución',
                          subtitle: 'Crear + listado + editar + eliminar',
                          onTap: () => Navigator.pushNamed(context, '/registro-devolucion'),
                        ),
                        _cardOpcion(
                          img: 'assets/img/devoluciones.png',
                          text: 'Tipo Devolución',
                          subtitle: 'Crear + editar + eliminar + reactivar',
                          onTap: () => Navigator.pushNamed(context, '/registro-tipo-devolucion'),
                        ),
                      ],
                    ),
                  ),
